...
namespace oap_pr21
{
    public partial class Form2 : Form
    {
        ...
        {
            InitializeComponent();
            comboBox1.Items.Add("Сортировка");
            comboBox2.Items.Add("Сортировка");
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                if (comboBox1.SelectedItem.ToString() == ("Сортировка"))
                {
            ...
            {
                MessageBox.Show("Вы не выбрали метод сортировки.");
            }
